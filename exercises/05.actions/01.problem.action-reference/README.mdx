...
🐨 First, let's update the <InlineFile file="src/actions.js" /> file to respond
properly. Then you can go to <InlineFile file="src/ship-details.js" /> to import
that action and send it along to the client component.

🐨 Finally in <InlineFile file="src/edit-text.js" /> you can accept the action
